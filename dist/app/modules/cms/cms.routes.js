...
const cms_validators_1 = require("../../validators/cms.validators");
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/', cms_validators_1.validateCMSPage, cmsController.createPage);
/**
 * @swagger
 * /cms/{id}:
 *   put:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.put('/:id', cms_validators_1.validateCMSPageUpdate, cmsController.updatePage);
/**
 * @swagger
 * /cms/{id}:
 *   delete:
